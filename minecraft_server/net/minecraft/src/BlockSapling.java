...
public class BlockSapling extends BlockFlower
{
        ...
        else if (i == 3)
        {
            ...
            do
            {
                ...
                do
                {
                    ...
                    if (func_50010_f(par1World, par2 + j, par3, par4 + k, 3) && func_50010_f(par1World, par2 + j + 1, par3, par4 + k, 3) && func_50010_f(par1World, par2 + j, par3, par4 + k + 1, 3) && func_50010_f(par1World, par2 + j + 1, par3, par4 + k + 1, 3))
                    {
    ...
    public boolean func_50010_f(World par1World, int par2, int par3, int par4, int par5)
    {
