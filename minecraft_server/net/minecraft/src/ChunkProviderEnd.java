...
public class ChunkProviderEnd implements IChunkProvider
{
    ...
    public void func_40184_a(int par1, int par2, byte par3ArrayOfByte[], BiomeGenBase par4ArrayOfBiomeGenBase[])
    {
        ...
        byte byte1 = 33;
        int j = byte0 + 1;
        densities = func_40186_a(densities, par1 * byte0, 0, par2 * byte0, i, byte1, j);
    ...
    public void func_40185_b(int par1, int par2, byte par3ArrayOfByte[], BiomeGenBase par4ArrayOfBiomeGenBase[])
    {
        for (int i = 0; i < 16; i++)
        {
            for (int j = 0; j < 16; j++)
    ...
    private double[] func_40186_a(double par1ArrayOfDouble[], int par2, int par3, int par4, int par5, int par6, int par7)
    {
