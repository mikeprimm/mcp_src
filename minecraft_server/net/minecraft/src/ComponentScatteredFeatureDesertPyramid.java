...
public class ComponentScatteredFeatureDesertPyramid extends ComponentScatteredFeature
{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        int k = getMetadataWithOffset(Block.field_56339_bQ.blockID, 3);
        int i1 = getMetadataWithOffset(Block.field_56339_bQ.blockID, 2);
        int j1 = getMetadataWithOffset(Block.field_56339_bQ.blockID, 0);
        int k1 = getMetadataWithOffset(Block.field_56339_bQ.blockID, 1);
        int l1 = 1;
        byte byte0 = 11;
