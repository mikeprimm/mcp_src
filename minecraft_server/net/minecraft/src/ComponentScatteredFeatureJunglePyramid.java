...
public class ComponentScatteredFeatureJunglePyramid extends ComponentScatteredFeature
{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        placeBlockAtCurrentPosition(par1World, Block.lever.blockID, BlockLever.func_56340_d(getMetadataWithOffset(Block.lever.blockID, 2)), 8, -2, 12, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.lever.blockID, BlockLever.func_56340_d(getMetadataWithOffset(Block.lever.blockID, 2)), 9, -2, 12, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.lever.blockID, BlockLever.func_56340_d(getMetadataWithOffset(Block.lever.blockID, 2)), 10, -2, 12, par3StructureBoundingBox);
