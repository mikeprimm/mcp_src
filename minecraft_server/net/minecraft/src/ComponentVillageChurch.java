...
public class ComponentVillageChurch extends ComponentVillage
{
    ...
    public static ComponentVillageChurch func_56317_a(ComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        ...
        {
            return new ComponentVillageChurch(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6);
        }
    }
