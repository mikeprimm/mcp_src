...
public class ComponentVillageField2 extends ComponentVillage
{
    ...
    public static ComponentVillageField2 func_56315_a(ComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
