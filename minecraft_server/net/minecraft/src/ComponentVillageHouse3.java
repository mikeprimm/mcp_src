...
public class ComponentVillageHouse3 extends ComponentVillage
{
    ...
    public static ComponentVillageHouse3 func_56319_a(ComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        ...
        {
            return new ComponentVillageHouse3(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6);
        }
    }
