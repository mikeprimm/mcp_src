...
public class ComponentVillagePathGen extends ComponentVillageRoadPiece
{
    ...
    public static StructureBoundingBox func_35378_a(ComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6)
    {
