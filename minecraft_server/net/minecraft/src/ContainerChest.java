...
public class ContainerChest extends Container
{
    ...
    public ContainerChest(IInventory par1IInventory, IInventory par2IInventory)
    {
        ...
        for (int j = 0; j < numRows; j++)
        {
            ...
            {
                func_55143_a(new Slot(par2IInventory, i1 + j * 9, 8 + i1 * 18, 18 + j * 18));
            }
        }
        ...
        for (int k = 0; k < 3; k++)
        {
            ...
            {
                func_55143_a(new Slot(par1IInventory, j1 + k * 9 + 9, 8 + j1 * 18, 103 + k * 18 + i));
            }
        }

        for (int l = 0; l < 9; l++)
        {
            func_55143_a(new Slot(par1IInventory, l, 8 + l * 18, 161 + i));
        }
    }
