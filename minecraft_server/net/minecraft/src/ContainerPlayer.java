...
public class ContainerPlayer extends Container
{
    ...
    public ContainerPlayer(InventoryPlayer par1InventoryPlayer, boolean par2)
    {
        ...
        isLocalWorld = false;
        isLocalWorld = par2;
        func_55143_a(new SlotCrafting(par1InventoryPlayer.player, craftMatrix, craftResult, 0, 144, 36));

        for (int i = 0; i < 2; i++)
        {
            for (int i1 = 0; i1 < 2; i1++)
            {
                func_55143_a(new Slot(craftMatrix, i1 + i * 2, 88 + i1 * 18, 26 + i * 18));
            }
        }
        ...
        {
            int j1 = j;
            func_55143_a(new SlotArmor(this, par1InventoryPlayer, par1InventoryPlayer.getSizeInventory() - 1 - j, 8, 8 + j * 18, j1));
        }
        ...
        for (int k = 0; k < 3; k++)
        {
            ...
            {
                func_55143_a(new Slot(par1InventoryPlayer, k1 + (k + 1) * 9, 8 + k1 * 18, 84 + k * 18));
            }
        }

        for (int l = 0; l < 9; l++)
        {
            func_55143_a(new Slot(par1InventoryPlayer, l, 8 + l * 18, 142));
        }
