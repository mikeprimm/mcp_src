...
{
    private boolean field_56124_a;
    private double field_56123_b;
    ...
    public EntityBoat(World par1World)
    {
        super(par1World);
        field_56124_a = true;
        field_56123_b = 0.070000000000000007D;
    ...
    public void onUpdate()
    {
        ...
        for (int j = 0; j < i; j++)
        {
            ...
            AxisAlignedBB axisalignedbb = AxisAlignedBB.func_58089_a().func_58067_a(boundingBox.minX, d2, boundingBox.minZ, boundingBox.maxX, d8, boundingBox.maxZ);
        ...
        if (worldObj.isRemote && field_56124_a)
        {
            if (boatPosRotationIncrements > 0)
            {
                ...
                for (d18 = boatYaw - (double)rotationYaw; d18 < -180D; d18 += 360D) { }
        ...
        if (riddenByEntity != null)
        {
            motionX += riddenByEntity.motionX * field_56123_b;
            motionZ += riddenByEntity.motionZ * field_56123_b;
        }
        ...
        if (d7 > d1 && field_56123_b < 0.34999999999999998D)
        {
            field_56123_b += (0.34999999999999998D - field_56123_b) / 35D;

            if (field_56123_b > 0.34999999999999998D)
            {
                field_56123_b = 0.34999999999999998D;
            }
        }
        else
        {
            field_56123_b -= (field_56123_b - 0.070000000000000007D) / 35D;

            if (field_56123_b < 0.070000000000000007D)
            {
                field_56123_b = 0.070000000000000007D;
            }
        }
        ...
        for (d21 = d13 - (double)rotationYaw; d21 >= 180D; d21 -= 360D) { }

        for (; d21 < -180D; d21 += 360D) { }
