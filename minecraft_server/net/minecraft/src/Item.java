...
public class Item
{
    private CreativeTabs field_56456_a;
    ...
    public static Item field_56457_n;
    ...
    public static Item field_55176_bF;
    public static Item field_55177_bG = (new ItemEditableBook(131)).setIconCoord(12, 11).setItemName("writtenBook");
    ...
    public boolean func_58049_a(ItemStack par1ItemStack, World par2World, int par3, int i, int j, int k, EntityLiving entityliving)
    {
        return false;
    }
    ...
    public String func_56453_e(ItemStack par1ItemStack)
    {
        return StatCollector.translateToLocal((new StringBuilder()).append(getItemNameIS(par1ItemStack)).append(".name").toString());
    }
    ...
    protected MovingObjectPosition getMovingObjectPositionFromPlayer(World par1World, EntityPlayer par2EntityPlayer, boolean par3)
    {
        ...
        return par1World.rayTraceBlocks_do_do(vec3, vec3_1, par3, !par3);
    }
    ...
    public Item func_56455_a(CreativeTabs par1CreativeTabs)
    {
        field_56456_a = par1CreativeTabs;
        return this;
    }
    ...
    static
    {
        ...
        arrow = (new Item(6)).setIconCoord(5, 2).setItemName("arrow").func_56455_a(CreativeTabs.field_56394_j);
        field_56457_n = (new Item(8)).setIconCoord(7, 3).setItemName("diamond").func_56455_a(CreativeTabs.field_56392_l);
        ingotIron = (new Item(9)).setIconCoord(7, 1).setItemName("ingotIron").func_56455_a(CreativeTabs.field_56392_l);
        ingotGold = (new Item(10)).setIconCoord(7, 2).setItemName("ingotGold").func_56455_a(CreativeTabs.field_56392_l);
        ...
        stick = (new Item(24)).setIconCoord(5, 3).setFull3D().setItemName("stick").func_56455_a(CreativeTabs.field_56392_l);
        bowlEmpty = (new Item(25)).setIconCoord(7, 4).setItemName("bowl").func_56455_a(CreativeTabs.field_56392_l);
        ...
        silk = (new ItemReed(31, Block.field_56333_bU)).setIconCoord(8, 0).setItemName("string").func_56455_a(CreativeTabs.field_56392_l);
        feather = (new Item(32)).setIconCoord(8, 1).setItemName("feather").func_56455_a(CreativeTabs.field_56392_l);
        gunpowder = (new Item(33)).setIconCoord(8, 2).setItemName("sulphur").setPotionEffect(PotionHelper.gunpowderEffect).func_56455_a(CreativeTabs.field_56392_l);
        ...
        wheat = (new Item(40)).setIconCoord(9, 1).setItemName("wheat").func_56455_a(CreativeTabs.field_56392_l);
        ...
        flint = (new Item(62)).setIconCoord(6, 0).setItemName("flint").func_56455_a(CreativeTabs.field_56392_l);
        ...
        leather = (new Item(78)).setIconCoord(7, 6).setItemName("leather").func_56455_a(CreativeTabs.field_56392_l);
        bucketMilk = (new ItemBucketMilk(79)).setIconCoord(13, 4).setItemName("milk").setContainerItem(bucketEmpty);
        brick = (new Item(80)).setIconCoord(6, 1).setItemName("brick").func_56455_a(CreativeTabs.field_56392_l);
        clay = (new Item(81)).setIconCoord(9, 3).setItemName("clay").func_56455_a(CreativeTabs.field_56392_l);
        reed = (new ItemReed(82, Block.reed)).setIconCoord(11, 1).setItemName("reeds").func_56455_a(CreativeTabs.field_56392_l);
        paper = (new Item(83)).setIconCoord(10, 3).setItemName("paper").func_56455_a(CreativeTabs.field_56383_f);
        book = (new Item(84)).setIconCoord(11, 3).setItemName("book").func_56455_a(CreativeTabs.field_56383_f);
        slimeBall = (new Item(85)).setIconCoord(14, 1).setItemName("slimeball").func_56455_a(CreativeTabs.field_56383_f);
        compass = (new Item(89)).setIconCoord(6, 3).setItemName("compass").func_56455_a(CreativeTabs.field_56397_i);
        pocketSundial = (new Item(91)).setIconCoord(6, 4).setItemName("clock").func_56455_a(CreativeTabs.field_56397_i);
        lightStoneDust = (new Item(92)).setIconCoord(9, 4).setItemName("yellowDust").setPotionEffect(PotionHelper.glowstoneEffect).func_56455_a(CreativeTabs.field_56392_l);
        bone = (new Item(96)).setIconCoord(12, 1).setItemName("bone").setFull3D().func_56455_a(CreativeTabs.field_56383_f);
        sugar = (new Item(97)).setIconCoord(13, 0).setItemName("sugar").setPotionEffect(PotionHelper.sugarEffect).func_56455_a(CreativeTabs.field_56392_l);
        cake = (new ItemReed(98, Block.cake)).setMaxStackSize(1).setIconCoord(13, 1).setItemName("cake").func_56455_a(CreativeTabs.field_56396_h);
        redstoneRepeater = (new ItemReed(100, Block.redstoneRepeaterIdle)).setIconCoord(6, 5).setItemName("diode").func_56455_a(CreativeTabs.field_56385_d);
        ...
        blazeRod = (new Item(113)).setIconCoord(12, 6).setItemName("blazeRod").func_56455_a(CreativeTabs.field_56392_l);
        ghastTear = (new Item(114)).setIconCoord(11, 7).setItemName("ghastTear").setPotionEffect(PotionHelper.ghastTearEffect).func_56455_a(CreativeTabs.field_56395_k);
        goldNugget = (new Item(115)).setIconCoord(12, 7).setItemName("goldNugget").func_56455_a(CreativeTabs.field_56392_l);
        ...
        fermentedSpiderEye = (new Item(120)).setIconCoord(10, 8).setItemName("fermentedSpiderEye").setPotionEffect(PotionHelper.fermentedSpiderEyeEffect).func_56455_a(CreativeTabs.field_56395_k);
        blazePowder = (new Item(121)).setIconCoord(13, 9).setItemName("blazePowder").setPotionEffect(PotionHelper.blazePowderEffect).func_56455_a(CreativeTabs.field_56395_k);
        magmaCream = (new Item(122)).setIconCoord(13, 10).setItemName("magmaCream").setPotionEffect(PotionHelper.magmaCreamEffect).func_56455_a(CreativeTabs.field_56395_k);
        brewingStand = (new ItemReed(123, Block.brewingStand)).setIconCoord(12, 10).setItemName("brewingStand").func_56455_a(CreativeTabs.field_56395_k);
        cauldron = (new ItemReed(124, Block.cauldron)).setIconCoord(12, 9).setItemName("cauldron").func_56455_a(CreativeTabs.field_56395_k);
        speckledMelon = (new Item(126)).setIconCoord(9, 8).setItemName("speckledMelon").setPotionEffect(PotionHelper.speckledMelonEffect).func_56455_a(CreativeTabs.field_56395_k);
        field_55176_bF = (new ItemWritableBook(130)).setIconCoord(11, 11).setItemName("writingBook").func_56455_a(CreativeTabs.field_56383_f);
        diamond = (new Item(132)).setIconCoord(10, 11).setItemName("emerald").func_56455_a(CreativeTabs.field_56392_l);
        StatList.initStats();
    }
}
