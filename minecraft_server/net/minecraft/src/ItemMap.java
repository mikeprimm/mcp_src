...
public class ItemMap extends ItemMapBase
{
    ...
    public void updateMapData(World par1World, Entity par2Entity, MapData par3MapData)
    {
        ...
        par3MapData.field_28159_g++;

        for (int k1 = (l - j1) + 1; k1 < l + j1; k1++)
        {
            if ((k1 & 0xf) != (par3MapData.field_28159_g & 0xf))
            {
                continue;
            }
            ...
            if (l1 <= i2)
            {
                par3MapData.func_28153_a(k1, l1, i2);
            }
        }
    }
    ...
    public void onUpdate(ItemStack par1ItemStack, World par2World, Entity par3Entity, int par4, boolean par5)
    {
        ...
        if (par3Entity instanceof EntityPlayer)
        {
            ...
            mapdata.func_28155_a(entityplayer, par1ItemStack);
        }
    ...
    {
        byte abyte0[] = getMapData(par1ItemStack, par2World).func_28154_a(par1ItemStack, par2World, par3EntityPlayer);
        ...
        {
            return new Packet131MapData((short)Item.map.shiftedIndex, (short)par1ItemStack.getItemDamage(), abyte0);
        }
    }
}
