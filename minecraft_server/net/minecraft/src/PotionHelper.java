...
public class PotionHelper
{
    ...
    private static int func_40554_a(String par0Str, int par1, int par2, int par3)
    {
        ...
        if (i >= 0 && i < par2)
        {
            int j = func_40554_a(par0Str, par1, i - 1, par3);
            ...
            int l = func_40554_a(par0Str, i + 1, par2, par3);
        ...
        if (k >= 0 && k < par2)
        {
            int i1 = func_40554_a(par0Str, par1, k - 1, par3);
            ...
            int j1 = func_40554_a(par0Str, k + 1, par2, par3);
        ...
        for (int j2 = par1; j2 < par2; j2++)
        {
            ...
            if (c == '!')
            {
                if (flag2)
                {
                    i2 += func_40546_a(flag3, flag1, flag4, byte0, k1, l1, par3);
    ...
    public static List getPotionEffects(int par0, boolean par1)
    {
        ...
        for (int j = 0; j < i; j++)
        {
            ...
            int k = func_40554_a(s, 0, s.length(), par0);
            ...
            if (s1 != null)
            {
                l = func_40554_a(s1, 0, s1.length(), par0);
