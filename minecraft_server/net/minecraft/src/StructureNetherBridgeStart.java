...
class StructureNetherBridgeStart extends StructureStart
{
    public StructureNetherBridgeStart(World par1World, Random par2Random, int par3, int par4)
    {
        ...
        for (ArrayList arraylist = componentnetherbridgestartpiece.field_40293_d; !arraylist.isEmpty(); structurecomponent.buildComponent(componentnetherbridgestartpiece, components, par2Random))
        {
