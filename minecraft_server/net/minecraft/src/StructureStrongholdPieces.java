...
public class StructureStrongholdPieces
{
        ...
        else
        {
            ...
            while (var13 < 5)
            {
                ...
                while (var10.hasNext())
                {
                    ...
                    if (var9 < 0)
                    {
                        if (!var11.canSpawnMoreStructuresOfType(par7) || var11 == par0ComponentStrongholdStairs2.field_35329_a)
                        {
                            break;
                        }
                        ...
                        if (var12 != null)
                        {
                            ...
                            par0ComponentStrongholdStairs2.field_35329_a = var11;
            ...
            StructureBoundingBox var14 = ComponentStrongholdCorridor.func_35342_a(par1List, par2Random, par3, par4, par5, par6);
    ...
    private static StructureComponent getNextValidComponent(ComponentStrongholdStairs2 par0ComponentStrongholdStairs2, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        ...
        if (componentstronghold != null)
        {
            ...
            par0ComponentStrongholdStairs2.field_35328_b.add(componentstronghold);
        }
