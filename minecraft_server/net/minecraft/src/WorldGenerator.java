...
public abstract class WorldGenerator
{
    ...
    protected void func_50023_a(World par1World, int par2, int par3, int par4, int par5)
    {
    ...
    protected void setBlockAndMetadata(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        else if (par1World.blockExists(par2, par3, par4) && par1World.getChunkFromBlockCoords(par2, par4).field_50025_o)
        {
